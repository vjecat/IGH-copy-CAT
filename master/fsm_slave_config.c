        ...
        )
{
    ...
    // EC_FMMU_PAGE_SIZE * slave->base_fmmu_count
    ec_datagram_fpwr(datagram, slave->station_address, 0x0600, 48);	
    
     
     if (slave->sii.product_code == 0x19004014)
    {
			/** luigi  clear >>> CONFIG */
		...
		EC_WRITE_U64(fsm->datagram->data+32, 0x0000000109000000);
		// datagram 0d 08 00 01 01 00 00 00
		EC_WRITE_U64(fsm->datagram->data+40, 0x000000010100080d);
    }
    else {
